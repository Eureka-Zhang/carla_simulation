...
# 用法：
#   1) 在 phase1 目录执行：powershell -ExecutionPolicy Bypass -File .\launch_car_following.ps1
#      或在仓库根目录：powershell -ExecutionPolicy Bypass -File .\phase1\launch_car_following.ps1
